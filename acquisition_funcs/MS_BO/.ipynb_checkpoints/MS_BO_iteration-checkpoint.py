...
from functions.processing_funcs import normalize, unnormalize, standardize, get_gen_bounds, get_random_observations
...
def msbo_iteration(X, y, c, c_inv, bounds=None, acqf_str='', decay=None, iter=None, count=None, consumed_budget=None, params=None):
    ...
    norm_bounds = get_gen_bounds([last_stage_idx], params['normalization_bounds'], bound_type='norm')
